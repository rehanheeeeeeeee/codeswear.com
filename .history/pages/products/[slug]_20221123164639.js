    ...
    <section className="text-gray-600 body-font overflow-hidden">
      ...
      <div className="container px-5 py-24 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap bg-white">
          <Image
            alt="ecommerce"
            className="lg:w-1/2 lg:pr-10 w-full lg:h-96 h-64 object-contain bg-white rounded"
            src={img}
            width={1920}
            height={256}
          />
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <h1 className="text-gray-900 whitespace-nowrap text-3xl title-font font-medium mb-1">
