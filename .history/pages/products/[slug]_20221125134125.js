...
export default function ProductPage({ item, types, items }) {
  ...
  console.log(types[selectedColor] ? Object.keys(types[selectedColor]) : null);
  const [selectedSize, setSelectedSize] = useState(
    types[selectedColor] ? Object.keys(types[selectedColor])[0] : null
  );
  ...
  // useEffect(() => {
  //   setSelectedSize(Object.keys(types[selectedColor])[0]);
  // }, [types, selectedColor]);
