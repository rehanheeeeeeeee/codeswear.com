  ...
  return (
    <section className="text-gray-600 body-font overflow-hidden">
      <ToastContainer
        ...
        theme="light"
      />
      <div className="container px-10 py-24 mx-auto w-full">
        <div className="flex items-center lg:w-4/5 mx-auto flex flex-wrap bg-white">
          <Image
            alt="ecommerce"
            className=" lg:h-96 h-64 object-contain bg-white rounded"
            src={img}
            width={1920}
            height={256}
          />
