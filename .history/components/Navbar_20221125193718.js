...
const styles = {
  container:
    "sticky left-0 right-0 top-0 z-10 bg-white w-full flex items-center md:space-x-5 flex-col md:px-8 pb-3 pt-1 md:justify-start shadow-md md:flex-row  space-y-3 justify-between",
