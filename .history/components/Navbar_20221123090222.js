...
const styles = {
  ...
  dropDown:
    "absolute top-5 right-20 bg-pink-300 rounded-lg shadow-md p-3 space-y-2",
  userOption:
    "p-2 transition cursor-poniter ease-in duration-100 rounded-lg hover:bg-pink-400 ",
};
        ...
        {!user ? (
          ...
          <>
            <div
              ...
              className="absolute right-14 md:right-16 md:top-0.5 top-1"
            >
            ...
            {dropdown && (
              ...
              >
                ...
                <p className={styles.userOption}>Order</p>
                <p
                  className={styles.userOption}
                  onClick={() => dispatch(emptyUser())}
                >
                  Sign out
                </p>
              </motion.div>
