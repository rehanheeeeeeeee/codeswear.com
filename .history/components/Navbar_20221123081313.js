...
const styles = {
  ...
  icon: "md:absolute right-14 md:right-20 top-2 md:top-0.5  text-2xl md:text-3xl font-extrabold text-pink-600 hover:text-pink-800 transition ease-in duration-100",
    ...
    <>
      <nav className={styles.container}>
        ...
        <div
          ...
          className="absolute right-4 cursor-pointer top-2 md:top-0.5"
        >
